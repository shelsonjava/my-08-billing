...
update PARTNIOR_TABLE t set t.phone_number_id =(select pn.phone_number_id from phone_numbers pn where pn.phone=to_char(t.phone_number)) where t.just_imported is null;
...
where t.phone_number_id is not null and t.just_imported is null;
update PARTNIOR_TABLE t set t.phone_number_id=null where t.phone_number_id is not null and t.subscriber_id is null and t.org_department_ids is null and t.just_imported is null;
--update PARTNIOR_TABLE t set t.priority=null;
update PARTNIOR_TABLE t set t.priority=0 where t.phone_number_id is null and t.just_imported is null;
...
update PARTNIOR_TABLE t
 ...
 where t.subscriber_id is not null and t.just_imported is null;
update PARTNIOR_TABLE t
 ...
 where t.org_department_ids is not null
   and t.org_department_count = 1 and t.just_imported is null;
   
update PARTNIOR_TABLE t set t.just_imported = 0 where t.just_imported is null;
