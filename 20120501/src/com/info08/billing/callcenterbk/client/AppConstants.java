 ...
 * com.info08.billing.callcenterbk.client.AppConstants.properties.
 * <p>
...
public interface AppConstants extends Constants {
	...
	String billingComps();
	String companyName();
	String addBillingComp();
	String editBillingComp();
	String companyNameFull();
	String startIndex();
	String endIndex();
	String partial();
	String full();
	String addBillingCompInd();
	String editBillingCompInd();
	...
	String ourPercent();
	String plzEnterBillingCompName();
