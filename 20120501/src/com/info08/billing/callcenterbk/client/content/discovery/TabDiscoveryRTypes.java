...
public class TabDiscoveryRTypes extends Tab {
	...
	public TabDiscoveryRTypes() {
		try {
			...
			datasource.getField("response_type").setTitle(CallCenterBK.constants.status());
			...
			ListGridField response_type = new ListGridField("response_type",CallCenterBK.constants.status(), 190);
