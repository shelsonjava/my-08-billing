...
public class DlgResolveDiscovery extends Window {
	...
	private DlgDiscoveryManager discoveryManager;

	public DlgResolveDiscovery(DlgDiscoveryManager discoveryManager,
	...
	private void saveDiscovery() {
		try {
			...
			record.setAttribute("response_type_id", new Integer(
					response_type_id_str));
			...
			req.setAttribute("operationId", "resolveDiscovery");
			discoveryDS.updateData(record, new DSCallback() {
				@Override
