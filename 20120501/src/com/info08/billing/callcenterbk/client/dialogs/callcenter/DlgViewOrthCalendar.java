...
public class DlgViewOrthCalendar extends Window {
	...
	public DlgViewOrthCalendar(ListGrid listGrid, DataSource dataSource,
		...
		detailViewer
				.setFields(calendar_day, event, state, calendar_description);
	...
	private void destroyDlg() {
		try {
			final DlgViewOrthCalendar dlgViewIndex = this;
