...
public class DlgAddEditNonStandartInfoGroup extends Window {
	...
	public DlgAddEditNonStandartInfoGroup(ListGrid listGrid, ListGridRecord pRecord) {
		try {
			this.editRecord = pRecord;
			this.listGrid = listGrid;
			setTitle(pRecord == null ? CallCenterBK.constants.addNonStandInofCatTitle()
					: CallCenterBK.constants.editNonStandInofCatTitle());
