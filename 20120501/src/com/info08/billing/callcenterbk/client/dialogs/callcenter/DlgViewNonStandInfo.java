...
public class DlgViewNonStandInfo extends MyWindow {
	...
	public DlgViewNonStandInfo(ListGrid listGrid, DataSource dataSource,
	...
	private void destroyDlg() {
		try {
			final DlgViewNonStandInfo dlgViewIndex = this;
