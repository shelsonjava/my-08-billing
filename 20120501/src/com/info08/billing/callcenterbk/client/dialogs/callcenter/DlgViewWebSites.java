...
public class DlgViewWebSites extends Window {
	...
	public DlgViewWebSites(ListGrid listGrid, DataSource dataSource,
			ListGridRecord listGridRecord) {
		this.listGridRecord = listGridRecord;

		setTitle(CallCenter.constants.sites());
		...
		sendSMS = new ToolStripButton(CallCenter.constants.smsWebSiteInfo(),
				"sms.png");
		...
		DetailViewerField main_detail_eng = new DetailViewerField(
				"main_detail_eng", CallCenter.constants.webSite());
	...
	private void destroyDlg() {
		try {
			final DlgViewWebSites dlgViewIndex = this;
	...
	private void sendSMS() {
		try {
			...
			recordParam
					.setAttribute("service_id", Constants.serviceWebSiteInfo);
			recordParam
