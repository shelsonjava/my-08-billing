...
import com.info08.billing.callcenter.shared.entity.control.LogPersonellNote;
import com.info08.billing.callcenter.shared.items.LogPersNoteItem;
	...
	public LogPersNoteItem add(LogPersNoteItem record) throws Exception {
		...
		try {
			...
			insertStatement = connection
					.prepareCall("{ call info.newBillSupport2.psaveOrUpdateLogPersNote( ?,?,?,?,?,?,?,?,?,?,? ) }");
