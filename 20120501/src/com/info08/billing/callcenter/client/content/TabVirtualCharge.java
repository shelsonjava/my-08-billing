...
import com.info08.billing.callcenter.client.dialogs.correction.DlgAddVirtualCharge;
...
public class TabVirtualCharge extends Tab {
	...
	public TabVirtualCharge() {
		...
		setTitle(CallCenter.constants.virtualCharge());
		setCanClose(true);
		...
		ToolStripButton addCharge = new ToolStripButton(
				CallCenter.constants.charge(), "moneySmall.png");
