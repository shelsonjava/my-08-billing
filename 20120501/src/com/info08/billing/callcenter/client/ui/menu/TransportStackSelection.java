...
import com.info08.billing.callcenter.client.content.transport.TabTransport;
import com.info08.billing.callcenter.client.content.transport.TabTransportCityBus;
import com.info08.billing.callcenter.client.content.transport.TabTransportCityBusStreet;
import com.info08.billing.callcenter.client.content.transport.TabTransportCompany;
import com.info08.billing.callcenter.client.content.transport.TabTransportPlaces;
import com.info08.billing.callcenter.client.content.transport.TabTransportType;
...
public class TransportStackSelection extends SectionStackSection {
	...
	private void openTab(String menuId) {
		...
		if (menuId.equals("100")) {
			...
			TabTransportCityBus tabTransportCityBus = new TabTransportCityBus();
