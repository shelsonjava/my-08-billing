...
import com.info08.billing.callcenter.server.common.ServerSingleton;
...
import com.info08.billing.callcenter.shared.entity.calendar.CalendarState;
import com.info08.billing.callcenter.shared.entity.calendar.ChurchCalendar;
import com.info08.billing.callcenter.shared.entity.calendar.ChurchCalendarEvent;
import com.info08.billing.callcenter.shared.entity.calendar.SecularCalendar;
import com.info08.billing.callcenter.shared.entity.calendar.SecularCalendarEvent;
import com.info08.billing.callcenter.shared.entity.main.MainDetail;
import com.info08.billing.callcenter.shared.entity.main.MainDetailType;
	...
	public MainDetail addOrUpdateMainDetail(DSRequest dsRequest)
		...
		try {
			...
			insertStatement = connection
					.prepareCall("{ call info.newBillSupport2.saveOrUpdateMainDetail( ?,?,?,?,?,?,?,?,?,?,?,?,?,? ) }");
	...
	public Object addLogSessionCharge(DSRequest dsRequest)
		...
		try {
			...
			if (service_id.equals(-3) || service_id.equals(3)) {
				insertStatement = connection
						.prepareCall("{ call info.insert_orgsession_charge( ?,?,?,? ) }");
				...
				insertStatement = connection
						.prepareCall("{ call info.insert_session_charge( ?,?,? ) }");
				insertStatement.setInt(1, service_id);
				insertStatement.setString(2, session_id);
				insertStatement.setInt(3, ym);
			}
