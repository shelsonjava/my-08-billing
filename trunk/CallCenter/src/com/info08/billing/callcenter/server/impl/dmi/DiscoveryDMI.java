...
import com.info08.billing.callcenter.shared.entity.discovery.DiscoverRtype;
import com.info08.billing.callcenter.shared.entity.discovery.DiscoverType;
...
public class DiscoveryDMI implements QueryConstants {
	...
	public Discover updateDiscoverItem(Map record) throws Exception {
		...
		try {
			...
			List resultList = oracleManager.createNativeQuery(QueryConstants.Q_GET_DISCOVERY_RECORD).setParameter(1, discover_id).getResultList();
			...
			discoverRet.setDiscover_type(columns[0]==null?null:columns[0].toString());
			discoverRet.setResponse_type(columns[1]==null?null:columns[1].toString());
			discoverRet.setDiscover_id(new Long(columns[2]==null?"-1":columns[2].toString()));
			discoverRet.setCall_id(columns[3]==null?null:columns[3].toString());
			discoverRet.setPhone(columns[4]==null?null:columns[4].toString());
			discoverRet.setDiscover_txt(columns[5]==null?null:columns[5].toString());
			discoverRet.setContact_phone(columns[6]==null?null:columns[6].toString());
			discoverRet.setDiscover_type_id(new Long(columns[7]==null?"-1":columns[7].toString()));
			discoverRet.setRec_date(columns[8]==null?null:(Date)columns[8]);
//			if(columns[8]!=null){
...
//			}			
			discoverRet.setRec_user(columns[9]==null?null:columns[9].toString());
			discoverRet.setDeleted(new Long(columns[10]==null?"-1":columns[10].toString()));
			discoverRet.setUpd_date(columns[11]==null?null:(Date)columns[11]);
			discoverRet.setUpd_user(columns[12]==null?null:columns[12].toString());
			discoverRet.setResponse_type_id(new Long(columns[13]==null?"-1":columns[13].toString()));
			discoverRet.setContact_person(columns[14]==null?null:columns[14].toString());
			discoverRet.setExecution_status(new Long(columns[15]==null?"-1":columns[15].toString()));
			discoverRet.setCcr(new Long(columns[16]==null?"-1":columns[16].toString()));
			discoverRet.setIscorrect(new Long(columns[17]==null?"-1":columns[17].toString()));
			discoverRet.setIs_locked(new Long(columns[18]==null?"-1":columns[18].toString()));
			discoverRet.setStart_date(columns[19]==null?null:(Date)columns[19]);
			discoverRet.setPersonnel_id(new Long(columns[20]==null?"-1":columns[20].toString()));
			discoverRet.setPersonnel_id1(new Long(columns[21]==null?"-1":columns[21].toString()));
			
			System.out.println("++++++++++++++++++++++++++++++");
			System.out.println("discover = " + discover);
			if (discoverRet != null) {
				System.out.println("getCall_id = "+discoverRet.getCall_id());
				System.out.println("getContact_person = "+discoverRet.getContact_person());
				System.out.println("getContact_phone = "+discoverRet.getContact_phone());
				System.out.println("getDiscover_txt = "+discoverRet.getDiscover_txt());
				System.out.println("getDiscover_type = "+discoverRet.getDiscover_type());
				System.out.println("getPhone = "+discoverRet.getPhone());
				System.out.println("getRec_user = "+discoverRet.getRec_user());
				System.out.println("getResponse_type = "+discoverRet.getResponse_type());
				//System.out.println("getStatus_descr = "+discoverRet.getStatus_descr());
				System.out.println("getUpd_user = "+discoverRet.getUpd_user());
				System.out.println("getCcr = "+discoverRet.getCcr());
				System.out.println("getDeleted = "+discoverRet.getDeleted());
				System.out.println("getDiscover_id = "+discoverRet.getDiscover_id());
				System.out.println("getDiscover_type_id = "+discoverRet.getDiscover_type_id());
				System.out.println("getExecution_status = "+discoverRet.getExecution_status());
				System.out.println("getIs_locked = "+discoverRet.getIs_locked());
				System.out.println("getIscorrect = "+discoverRet.getIscorrect());
				System.out.println("getIscorrect = "+discoverRet.getIscorrect());
				System.out.println("getResponse_type_id = "+discoverRet.getResponse_type_id());
				System.out.println("getRec_date = "+discoverRet.getRec_date());
				System.out.println("getUpd_date = "+discoverRet.getUpd_date());
				System.out.println("getPersonnel_id = "+discoverRet.getPersonnel_id());
				System.out.println("getPersonnel_id1 = "+discoverRet.getPersonnel_id1());
				System.out.println("getStart_date = "+discoverRet.getStart_date());
			}
			System.out.println("++++++++++++++++++++++++++++++");
