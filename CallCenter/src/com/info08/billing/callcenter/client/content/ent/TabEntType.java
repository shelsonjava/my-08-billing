package com.info08.billing.callcenter.client.content.ent;

import com.info08.billing.callcenter.client.dialogs.ent.DlgAddEditEndType;
...
public class TabEntType extends Tab {
	...
	public TabEntType() {
		try {
			...
			datasource = DataSource.get("EntTypeDS");
			...
			addBtn.addClickHandler(new ClickHandler() {
				@Override
				public void onClick(ClickEvent event) {
					DlgAddEditEndType dlgAddEditEndType = new DlgAddEditEndType(
							listGrid, null);
					dlgAddEditEndType.show();
				}
			});
